...
%\begin{footnotesize}
\scalebox{0.45}{
\pstree[treemode=D,treesep=0.12]{\TC}{
 \pstree{\TC}
	...
	\begin{minipage}{0.45\textwidth}
		\begin{center}
			...
			\hspace*{1cm} \scalebox{0.55}{
				\pstree[treemode=R,levelsep=0.3]{\TC}{
					\pstree{\TC}
...
Assume for simplicity the recourses are complete.
...
\begin{frame}
	...
	\begin{center}
		...
		{\Tn} % root
		{\pstree{\TC~[tnpos=b, name=s0]{$x_1$}}{
				\pstree[linecolor=red]{\TC[name=s1a]~[tnpos=b]{$x_{2,1}$}}{
				...
				\pstree[linecolor=red]{\TC[name=s1b]~[tnpos=b]{$x_{2,s_{n_2}}$}}{
...
\begin{frame}
	...
	\begin{center}
		...
		{\Tn} % root
		{\pstree{\TC~[tnpos=b, name=s0]{$x_1$}}{
				\pstree{\TC[name=s1a]~[tnpos=b]{$x_{2,1}$}}{
					\pstree[linestyle=dashed, linecolor=red]{\TC[name=s2a]~[tnpos=b]{$x_{3,1}$}}
					{\Tdot[name=s4a] \Tdot[name=s4b]}            \pstree[linestyle=dashed, linecolor=red]{\TC[name=s2b]~[tnpos=b]{$x_{3,s_i}$}}
					{\Tdot[name=s4c] \Tdot[name=s4d]}
				}
				\pstree{\TC~[tnpos=b, name=s1b]{$x_{2,s_1}$}}{
					\pstree[linestyle=dashed, linecolor=red]{\TC[name=s2c]~[tnpos=b]{$x_{3,s_m}$}}
					{\Tdot[name=s4e] \Tdot[name=s4f]}            
					\pstree[linestyle=dashed, linecolor=red]{\TC[name=s2d]~[tnpos=b]{$x_{3,s_{n_3}}$}}
					{\Tdot[name=s4g] \Tdot[name=s4h]}
				}
			}
			% We add the stage identifiers.

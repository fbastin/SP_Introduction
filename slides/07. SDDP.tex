...
from below, one supporting hyperplane at a time. Under stagewise independence, the
...
returned by the solver.} The following is a valid feasibility cut for $NLSD(t - 1, a(k))$:
$$
...
By linear programming duality, the optimal value of $NLSD(t,k)$ evaluated at the trial
solution $\hat{x}_{t-1}$ is
$$

...
Historically, MRG32k3a was one of the few generators offering built-in functions for independent streams and substreams. Today, libraries like \texttt{RandomDataStreams.jl} extend this capability to a wide variety of generators in a unified framework.
...
\end{frame}
	...
	\begin{tikzpicture}[>=latex, scale=0.9, font=\small]
		...
		% Stream 1
		\draw[blue, thick, |-|] (0.5, 0.7) -- (4.5, 0.7) node[midway, above] {Stream 1};
		\draw[blue, thick, |-|] (0.5, -0.7) -- (1.5, -0.7) node[midway, below] {Sub 1.1};
		\draw[blue, thick, |-|] (1.5, -0.7) -- (2.5, -0.7) node[midway, below] {Sub 1.2};
		\draw[blue, thick, |-|] (2.5, -0.7) -- (3.5, -0.7) node[midway, below] {Sub 1.3};
		\draw[blue, dashed] (3.5, -0.7) -- (4.5, -0.7);

		% Stream 2
		\draw[red, thick, |-|] (4.5, 0.7) -- (8.5, 0.7) node[midway, above] {Stream 2};
		\draw[red, thick, |-|] (4.5, -0.7) -- (5.5, -0.7) node[midway, below] {Sub 2.1};
		\draw[red, thick, |-|] (5.5, -0.7) -- (6.5, -0.7) node[midway, below] {Sub 2.2};
		\draw[red, dashed] (6.5, -0.7) -- (8.5, -0.7);
		
		% Stream k
		\node at (9.5, 0.7) {$\cdots$};
		\node at (9.5, -0.7) {$\cdots$};
		
		\draw[green!60!black, thick, |-|] (10.5, 0.7) -- (12.5, 0.7) node[midway, above] {Stream $N$};
		
		% Vertical guides
		\draw[dashed, gray] (0.5, 0.9) -- (0.5, -0.9);
		\draw[dashed, gray] (4.5, 0.9) -- (4.5, -0.9);
		\draw[dashed, gray] (8.5, 0.9) -- (8.5, -0.9);
	\end{tikzpicture}
	\end{center}

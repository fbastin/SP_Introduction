...
stdmin = getlcg(1234, 16807, 0, 2^31-1)
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=0.8\linewidth]{lcg.png}
...
\item
The most popular implementation, Philox, detailed next, is the default generator in TensorFlow.
\item
...
\end{frame}
	...
	\url{https://github.com/JLChartrand/RandomDataStreams.jl}\\
	Documentation: \url{https://jlchartrand.github.io/RandomDataStreams.jl/dev/}
...
\begin{semiverbatim}
u = draw(stream = s, substream = r, position = i)
\end{semiverbatim}
...
\end{frame}
	...
	\begin{frame}
		...
		\begin{minipage}{0.47\linewidth}
			\includegraphics[width=\linewidth]{NormalRejectGrid.eps}
		\end{minipage}

...
It can be easily extended to unconstrained optimization using first-order condition as a necessary condition for the problem
$$
\min_{x \in \RR^d} \ f(x)
$$
is
...
If the number of iterations completed in $c$ units of computer time, $n(c)$ grows roughly linearly in $c$

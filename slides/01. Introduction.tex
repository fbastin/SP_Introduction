...
\begin{itemize}
	...
	\item
	Knowing the probability distribution $F(t) = P(\bsxi \leq t)$, how many newspapers should the newsvendor buys in order to maximize his revenue?
\end{itemize}
...
\]
\item
$\mathcal{Q}(x)$ is the expected sale amount if the newsvendor buyss $x$ newspapers:
\[
...
{\sl Other interpretation}, more intuitive: assume that the vendor has bought $t$ newspapers.

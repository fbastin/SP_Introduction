...
\item
{\red Notation}: throughout the course, $\pi$ denotes the multipliers attached to the
second-stage (recourse) and nonanticipativity constraints, and $\lambda$ those attached to the
first-stage constraints $g_i^1$, as in the KKT conditions above.
\item

...
\begin{itemize}
\item
The collaboration with Charnes was however successful, with more than 200 publications, and led a successful academic career.
\item 
...
Setting $b$ to 0 means that we want to ensure that we will not suffer from loss with some probability. Typically, $\alpha$ is set to 0.9, 0.95, 0.99,\ldots

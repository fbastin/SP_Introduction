...
\begin{frame}
	...
	& x_1, x_2 \geq 0,
	\end{align*}
	where $\bsxi_1 \sim U[1,4]$, $\bsxi_2[1/3,1]$.
...
Set $X = \RR^n_+$.
\[
\min_{x \in \RR^n_+ \,|\, Ax = b} \left\lbrace c^Tx + \EE_{\bsxi} \left[ \min_{y \in \RR^p_+} \lbrace q(\xi)^Ty \ |\ Wy = h(\bsxi) - T(\bsxi)x \rbrace \right] \right\rbrace 
\]
\[
...
$$
Note that $P\left[ \bsxi = 2^n \right] \in (0,1),\ n = 0,1,2,\ldots$, $\Xi = \lbrace 2^n,\ n \in \NN_+ \rbrace$, and
$$
...
\begin{align*}
\calQ(x) &= \EE_{\bsxi} \left[ \min_{y \geq 0} 2y_1+y_2 \,\bigg|\, y_1 + y_2 \geq 1 - x_1,\ y_1 \geq \xi - x_1 - x_2 \right] \\
&\geq \EE_{\bsxi} \left[ \min_{y_1 \geq 0} 2y_1 \,\bigg|\, y_1 \geq \xi - x_1 - x_2 \right] \\
